<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(userAddress,index) in addressInfo" :key="index">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(order,index) in tradeInfo.detailArrayList" :key="order.skuId">
          <li>
...
<script>
  ...
  export default {
    ...
    computed:{
      ...mapState('trade',['addressInfo','tradeInfo']),
      userDefaultAddress(){
        //查找数组当中符合条件的结果并且返回
    ...
    methods:{
      ...
      async submitOrder() {
        ...
        let data = {
          ...
          "deliveryAddress": this.userDefaultAddress.userAddress,  //收件人地址
